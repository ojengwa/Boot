            ...
            <div class="col-sm-6 col-md-offset-3">
                ...
                <div class="account-wall">
                    ...
                    ?>"
                        ...
                        if ($curUser) {
                            echo "<b> Currently logged in as " . $curUser->getEmail() . "</b>";
                        }
        				?>
        				</div>
                    ...
                    <a href="<?php
                    			if (array_key_exists("recoverpassword_url", $component_options)) {
                    				echo $component_options["recoverpassword_url"];
                                }
                                else {
                                    echo BOOTSITE_BASE_URL . "passwordrecovery";
                                }

                    		?>" class="pull-right need-help">Forgot Password? </a><span class="clearfix"></span>
                    </form>
                    <br/>
                    <a href="<?= $fb_auth_url ?>">
                ...
                <a href="<?php
                			...
                			if (array_key_exists("signup_url", $component_options)) {
                				echo $component_options["signup_url"];
                            }
                            else {
                                echo BOOTSITE_BASE_URL . "signup";
                            }
