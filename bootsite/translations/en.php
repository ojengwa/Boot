...
define("WORDING_REGISTRATION_EMAIL_HINT", "please provide a real email address, you'll get a verification mail with an activation link");
define("WORDING_REGISTRATION_PASSWORD", "Password");
define("WORDING_REGISTRATION_PASSWORD_REPEAT", "Repeat password");
define("WORDING_REGISTRATION_PASSWORD_HINT", "min. 6 characters!");
define("WORDING_REGISTRATION_USERNAME", "Username");
define("WORDING_REGISTRATION_USERNAME_HINT", "only letters and numbers, 2 to 64 characters");
